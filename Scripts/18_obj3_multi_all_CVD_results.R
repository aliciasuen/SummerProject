...
if(lasso){
  ...
  path_to_results = "/rds/general/project/hda_students_data/live/Group2/Alicia/Summer_project/Results_report/Multivariate_obj3/lasso/"
...
if(spls){
  ...
  combine = combine[order(as.numeric(row.names(combine))),] %>% as.matrix()
  cvd = readRDS(paste(path, "Results_report/updates/matched_cvd.rds",sep =""))
  path_to_results = "/rds/general/project/hda_students_data/live/Group2/Alicia/Summer_project/Results_report/Multivariate_obj3/spls/"
