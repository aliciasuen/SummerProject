...
if(cluster){
  ...
  path_to_figure = "/rds/general/project/hda_students_data/live/Group2/Alicia/Summer_project/Figure_report/Univariate_obj1/report/cluster/"
...
if(bio){
  path_to_Results_report = "/rds/general/project/hda_students_data/live/Group2/Alicia/Summer_project/Results_report/Univariate_obj1/Air_clus_bio/"
  path_to_figure = "/rds/general/project/hda_students_data/live/Group2/Alicia/Summer_project/Figure_report/Univariate_obj1/report/biomarker/"
...
if(comb){
  path_to_Results_report = "/rds/general/project/hda_students_data/live/Group2/Alicia/Summer_project/Results_report/Univariate_obj1/Air_clus_bio/"
  path_to_figure = "/rds/general/project/hda_students_data/live/Group2/Alicia/Summer_project/Figure_report/Univariate_obj1/report/combine/"
...
if(NO2){
  path_to_figure = "/rds/general/project/hda_students_data/live/Group2/Alicia/Summer_project/Figure_report/Multivariate_obj1/report/uni_lasso/NO2/"
  ...
  ## sel prop ##
  bio_sp = readRDS(paste(path_to_multi_Results_report, "selprop_bio_NO2.rds",sep=""))
  clus_sp = readRDS(paste(path_to_multi_Results_report, "selprop_metab_clus_NO2.rds",sep=""))
  combine_sp = readRDS(paste(path_to_multi_Results_report, "selprop_combine_NO2.rds",sep=""))
  ## out ## 
  out_bio = readRDS(paste(path_to_multi_Results_report, "out_bio_NO2.rds",sep=""))
  out_clus = readRDS(paste(path_to_multi_Results_report, "out_metab_clus_NO2.rds",sep=""))
  out_combine = readRDS(paste(path_to_multi_Results_report, "out_combine_NO2.rds",sep=""))
  ## betas ## 
  bio_betas  = readRDS(paste(path_to_multi_Results_report, "betas_bio_NO2.rds",sep=""))
  clus_betas  = readRDS(paste(path_to_multi_Results_report, "betas_stability_clus_NO2.rds",sep=""))
  combine_betas  = readRDS(paste(path_to_multi_Results_report, "betas_combine_NO2.rds",sep=""))
}
if(PM10){
  path_to_figure = "/rds/general/project/hda_students_data/live/Group2/Alicia/Summer_project/Figure_report/Multivariate_obj1/report/uni_lasso/PM10/"
  path_to_multi_Results_report = "/rds/general/project/hda_students_data/live/Group2/Alicia/Summer_project/Results_report/Multivariate_obj1/Air_clus_bio/lasso/pfer/"
  ## sel prop ##
  bio_sp = readRDS(paste(path_to_multi_Results_report, "selprop_bio_PM10.rds",sep=""))
  clus_sp = readRDS(paste(path_to_multi_Results_report, "selprop_metab_clus_PM10.rds",sep=""))
  combine_sp = readRDS(paste(path_to_multi_Results_report, "selprop_combine_PM10.rds",sep=""))
  ## out ## 
  out_bio = readRDS(paste(path_to_multi_Results_report, "out_bio_PM10.rds",sep=""))
  out_clus = readRDS(paste(path_to_multi_Results_report, "out_metab_clus_PM10.rds",sep=""))
  out_combine = readRDS(paste(path_to_multi_Results_report, "out_combine_PM10.rds",sep=""))
  ## betas ## 
  bio_betas  = readRDS(paste(path_to_multi_Results_report, "betas_bio_PM10.rds",sep=""))
  clus_betas  = readRDS(paste(path_to_multi_Results_report, "betas_stability_clus_PM10.rds",sep=""))
  combine_betas  = readRDS(paste(path_to_multi_Results_report, "betas_combine_PM10.rds",sep=""))
}
if(PM2.5){
  path_to_figure = "/rds/general/project/hda_students_data/live/Group2/Alicia/Summer_project/Figure_report/Multivariate_obj1/report/uni_lasso/PM2.5/"
  path_to_multi_Results_report = "/rds/general/project/hda_students_data/live/Group2/Alicia/Summer_project/Results_report/Multivariate_obj1/Air_clus_bio/lasso/pfer/"
  ## sel prop ##
  bio_sp = readRDS(paste(path_to_multi_Results_report, "selprop_bio_PM2.5.rds",sep=""))
  clus_sp = readRDS(paste(path_to_multi_Results_report, "selprop_metab_clus_PM2.5.rds",sep=""))
  combine_sp = readRDS(paste(path_to_multi_Results_report, "selprop_combine_PM2.5.rds",sep=""))
  ## out ## 
  out_bio = readRDS(paste(path_to_multi_Results_report, "out_bio_PM2.5.rds",sep=""))
  out_clus = readRDS(paste(path_to_multi_Results_report, "out_metab_clus_PM2.5.rds",sep=""))
  out_combine = readRDS(paste(path_to_multi_Results_report, "out_combine_PM2.5.rds",sep=""))
  ## betas ## 
  bio_betas  = readRDS(paste(path_to_multi_Results_report, "betas_bio_PM2.5.rds",sep=""))
  clus_betas  = readRDS(paste(path_to_multi_Results_report, "betas_stability_clus_PM2.5.rds",sep=""))
  combine_betas  = readRDS(paste(path_to_multi_Results_report, "betas_combine_PM2.5.rds",sep=""))
}
if(NOx){
  path_to_figure = "/rds/general/project/hda_students_data/live/Group2/Alicia/Summer_project/Figure_report/Multivariate_obj1/report/uni_lasso/NOx/"
  path_to_multi_Results_report = "/rds/general/project/hda_students_data/live/Group2/Alicia/Summer_project/Results_report/Multivariate_obj1/Air_clus_bio/lasso/pfer/"
  ## sel prop ##
  bio_sp = readRDS(paste(path_to_multi_Results_report, "selprop_bio_NOx.rds",sep=""))
  clus_sp = readRDS(paste(path_to_multi_Results_report, "selprop_metab_clus_NOx.rds",sep=""))
  combine_sp = readRDS(paste(path_to_multi_Results_report, "selprop_combine_NOx.rds",sep=""))
  ## out ## 
  out_bio = readRDS(paste(path_to_multi_Results_report, "out_bio_NOx.rds",sep=""))
  out_clus = readRDS(paste(path_to_multi_Results_report, "out_metab_clus_NOx.rds",sep=""))
  out_combine = readRDS(paste(path_to_multi_Results_report, "out_combine_NOx.rds",sep=""))
  ## betas ## 
  bio_betas  = readRDS(paste(path_to_multi_Results_report, "betas_bio_NOx.rds",sep=""))
  clus_betas  = readRDS(paste(path_to_multi_Results_report, "betas_stability_clus_NOx.rds",sep=""))
  combine_betas  = readRDS(paste(path_to_multi_Results_report, "betas_combine_NOx.rds",sep=""))
}
if(PM2.5_10){
  path_to_figure = "/rds/general/project/hda_students_data/live/Group2/Alicia/Summer_project/Figure_report/Multivariate_obj1/report/uni_lasso/PM2.5_10/"
  path_to_multi_Results_report = "/rds/general/project/hda_students_data/live/Group2/Alicia/Summer_project/Results_report/Multivariate_obj1/Air_clus_bio/lasso/pfer/"
  ## sel prop ##
  bio_sp = readRDS(paste(path_to_multi_Results_report, "selprop_bio_PM2.5_10.rds",sep=""))
  clus_sp = readRDS(paste(path_to_multi_Results_report, "selprop_metab_clus_PM2.5_10.rds",sep=""))
  combine_sp = readRDS(paste(path_to_multi_Results_report, "selprop_combine_PM2.5_10.rds",sep=""))
  ## out ## 
  out_bio = readRDS(paste(path_to_multi_Results_report, "out_bio_PM2.5_10.rds",sep=""))
  out_clus = readRDS(paste(path_to_multi_Results_report, "out_metab_clus_PM2.5_10.rds",sep=""))
  out_combine = readRDS(paste(path_to_multi_Results_report, "out_combine_PM2.5_10.rds",sep=""))
  ## betas ## 
  bio_betas  = readRDS(paste(path_to_multi_Results_report, "betas_bio_PM2.5_10.rds",sep=""))
  clus_betas  = readRDS(paste(path_to_multi_Results_report, "betas_stability_clus_PM2.5_10.rds",sep=""))
  combine_betas  = readRDS(paste(path_to_multi_Results_report, "betas_combine_PM2.5_10.rds",sep=""))
}
if(PM2.5_abs){
  path_to_figure = "/rds/general/project/hda_students_data/live/Group2/Alicia/Summer_project/Figure_report/Multivariate_obj1/report/uni_lasso/PM2.5_abs/"
  path_to_multi_Results_report = "/rds/general/project/hda_students_data/live/Group2/Alicia/Summer_project/Results_report/Multivariate_obj1/Air_clus_bio/lasso/pfer/"
  ## sel prop ##
  bio_sp = readRDS(paste(path_to_multi_Results_report, "selprop_bio_PM_abs.rds",sep=""))
  clus_sp = readRDS(paste(path_to_multi_Results_report, "selprop_metab_clus_PM_abs.rds",sep=""))
  combine_sp = readRDS(paste(path_to_multi_Results_report, "selprop_combine_PM_abs.rds",sep=""))
  ## out ## 
  out_bio = readRDS(paste(path_to_multi_Results_report, "out_bio_PM_abs.rds",sep=""))
  out_clus = readRDS(paste(path_to_multi_Results_report, "out_metab_clus_PM_abs.rds",sep=""))
  out_combine = readRDS(paste(path_to_multi_Results_report, "out_combine_PM_abs.rds",sep=""))
  ## betas ## 
  bio_betas  = readRDS(paste(path_to_multi_Results_report, "betas_bio_PM_abs.rds",sep=""))
  clus_betas  = readRDS(paste(path_to_multi_Results_report, "betas_stability_clus_PM_abs.rds",sep=""))
  combine_betas  = readRDS(paste(path_to_multi_Results_report, "betas_combine_PM_abs.rds",sep=""))
}
if(Major_road){
  path_to_figure = "/rds/general/project/hda_students_data/live/Group2/Alicia/Summer_project/Figure_report/Multivariate_obj1/report/uni_lasso/road/"
  path_to_multi_Results_report = "/rds/general/project/hda_students_data/live/Group2/Alicia/Summer_project/Results_report/Multivariate_obj1/Air_clus_bio/lasso/pfer/"
  ## sel prop ##
  bio_sp = readRDS(paste(path_to_multi_Results_report, "selprop_bio_road.rds",sep=""))
  clus_sp = readRDS(paste(path_to_multi_Results_report, "selprop_metab_clus_road.rds",sep=""))
  combine_sp = readRDS(paste(path_to_multi_Results_report, "selprop_combine_road.rds",sep=""))
  ## out ## 
  out_bio = readRDS(paste(path_to_multi_Results_report, "out_bio_road.rds",sep=""))
  out_clus = readRDS(paste(path_to_multi_Results_report, "out_metab_clus_road.rds",sep=""))
  out_combine = readRDS(paste(path_to_multi_Results_report, "out_combine_road.rds",sep=""))
  ## betas ## 
  bio_betas  = readRDS(paste(path_to_multi_Results_report, "betas_bio_road.rds",sep=""))
  clus_betas  = readRDS(paste(path_to_multi_Results_report, "betas_stability_clus_road.rds",sep=""))
  combine_betas  = readRDS(paste(path_to_multi_Results_report, "betas_combine_road.rds",sep=""))
}
...
pdf(paste(path_to_figure, "report_uni_NO2.pdf",sep =""), width = 5.5, height = 5.5)
p2
dev.off()
...
pdf(paste(path_to_figure, "report_uni_NOx.pdf",sep =""), width = 5.5, height = 5.5)
p2
dev.off()

# Univariate plot PM10-------------------------------------------------------------
pval = t(air_pval) %>% as.data.frame()
pval = pval[3]
bonf_threshold = -log10(0.05/(7*78))
...
pdf(paste(path_to_figure, "report_uni_PM10.pdf",sep =""), width = 5.5, height = 5.5)
p2
dev.off()
# Univariate plot PM2.5-------------------------------------------------------------
...
pdf(paste(path_to_figure, "report_uni_PM2.5.pdf",sep =""), width = 5.5, height = 5.5)
p2
dev.off()



# Univariate plot PM2.5_absorbance-------------------------------------------------------------
pval = t(air_pval) %>% as.data.frame()
pval = pval[5]
bonf_threshold = -log10(0.05/(7*78))
...
p2=ggplot(selection,
  ...
  xlab(expression(beta))+
  ylab("-log10(p-value)")+
  ggtitle("PM2.5 absorbance")+
  # xlim(xlim) +
  # ylim(ylim) +
  theme_bw() +
  theme(legend.position = "none")

pdf(paste(path_to_figure, "report_uni_abs.pdf",sep =""), width = 5.5, height = 5.5)
p2
dev.off()


# Univariate plot PM2.5-10-------------------------------------------------------------
...
pdf(paste(path_to_figure, "report_uni_PM2.5-10.pdf",sep =""), width = 5.5, height = 5.5)
p2
dev.off()
...
pdf(paste(path_to_figure, "report_uni_road.pdf",sep =""), width = 5.5, height = 5.5)
p2
dev.off()
