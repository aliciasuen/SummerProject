...
if(lasso_cvd){
  ...
  path_to_figure = "/rds/general/project/hda_students_data/live/Group2/Alicia/Summer_project/Figure_report/Multivariate_obj3/lasso/"
  path_to_multi_Results_report = "/rds/general/project/hda_students_data/live/Group2/Alicia/Summer_project/Results_report/Multivariate_obj3/lasso/"
  ## sel prop ##
...
# ---------------------Uni-multi-volcano----------------------------------------------------
path_to_figure = "/rds/general/project/hda_students_data/live/Group2/Alicia/Summer_project/Figure_report/Multivariate_obj3/lasso/uni_lasso/"
...
if(NO2){
  ...
  ## sel prop ##
  bio_sp_air = readRDS(paste(path_to_multi_Results_report, "selprop_bio_NO2.rds",sep=""))
  clus_sp_air = readRDS(paste(path_to_multi_Results_report, "selprop_metab_clus_NO2.rds",sep=""))
  combine_sp_air = readRDS(paste(path_to_multi_Results_report, "selprop_combine_NO2.rds",sep=""))
  ## out ## 
  out_bio_air = readRDS(paste(path_to_multi_Results_report, "out_bio_NO2.rds",sep=""))
  out_clus_air = readRDS(paste(path_to_multi_Results_report, "out_metab_clus_NO2.rds",sep=""))
  out_combine_air = readRDS(paste(path_to_multi_Results_report, "out_combine_NO2.rds",sep=""))
  ## betas ## 
  bio_betas_air  = readRDS(paste(path_to_multi_Results_report, "betas_bio_NO2.rds",sep=""))
  clus_betas_air  = readRDS(paste(path_to_multi_Results_report, "betas_stability_clus_NO2.rds",sep=""))
  combine_betas_air  = readRDS(paste(path_to_multi_Results_report, "betas_combine_NO2.rds",sep=""))
}
if(PM10){
  path_to_multi_Results_report = "/rds/general/project/hda_students_data/live/Group2/Alicia/Summer_project/Results_report/Multivariate_obj1/Air_clus_bio/lasso/pfer/"
  ## sel prop ##
  bio_sp_air= readRDS(paste(path_to_multi_Results_report, "selprop_bio_PM10.rds",sep=""))
  clus_sp_air = readRDS(paste(path_to_multi_Results_report, "selprop_metab_clus_PM10.rds",sep=""))
  combine_sp_air = readRDS(paste(path_to_multi_Results_report, "selprop_combine_PM10.rds",sep=""))
  ## out ## 
  out_bio_air = readRDS(paste(path_to_multi_Results_report, "out_bio_PM10.rds",sep=""))
  out_clus_air = readRDS(paste(path_to_multi_Results_report, "out_metab_clus_PM10.rds",sep=""))
  out_combine_air = readRDS(paste(path_to_multi_Results_report, "out_combine_PM10.rds",sep=""))
  ## betas ## 
  bio_betas_air  = readRDS(paste(path_to_multi_Results_report, "betas_bio_PM10.rds",sep=""))
  clus_betas_air  = readRDS(paste(path_to_multi_Results_report, "betas_stability_clus_PM10.rds",sep=""))
  combine_betas_air  = readRDS(paste(path_to_multi_Results_report, "betas_combine_PM10.rds",sep=""))
}
if(PM2.5){
  path_to_multi_Results_report = "/rds/general/project/hda_students_data/live/Group2/Alicia/Summer_project/Results_report/Multivariate_obj1/Air_clus_bio/lasso/pfer/"
  ## sel prop ##
  bio_sp_air = readRDS(paste(path_to_multi_Results_report, "selprop_bio_PM2.5.rds",sep=""))
  clus_sp_air = readRDS(paste(path_to_multi_Results_report, "selprop_metab_clus_PM2.5.rds",sep=""))
  combine_sp_air = readRDS(paste(path_to_multi_Results_report, "selprop_combine_PM2.5.rds",sep=""))
  ## out ## 
  out_bio_air = readRDS(paste(path_to_multi_Results_report, "out_bio_PM2.5.rds",sep=""))
  out_clus_air = readRDS(paste(path_to_multi_Results_report, "out_metab_clus_PM2.5.rds",sep=""))
  out_combine_air = readRDS(paste(path_to_multi_Results_report, "out_combine_PM2.5.rds",sep=""))
  ## betas ## 
  bio_betas_air  = readRDS(paste(path_to_multi_Results_report, "betas_bio_PM2.5.rds",sep=""))
  clus_betas_air  = readRDS(paste(path_to_multi_Results_report, "betas_stability_clus_PM2.5.rds",sep=""))
  combine_betas_air  = readRDS(paste(path_to_multi_Results_report, "betas_combine_PM2.5.rds",sep=""))
}
if(NOx){
  path_to_multi_Results_report = "/rds/general/project/hda_students_data/live/Group2/Alicia/Summer_project/Results_report/Multivariate_obj1/Air_clus_bio/lasso/pfer/"
  ## sel prop ##
  bio_sp_air = readRDS(paste(path_to_multi_Results_report, "selprop_bio_NOx.rds",sep=""))
  clus_sp_air = readRDS(paste(path_to_multi_Results_report, "selprop_metab_clus_NOx.rds",sep=""))
  combine_sp_air = readRDS(paste(path_to_multi_Results_report, "selprop_combine_NOx.rds",sep=""))
  ## out ## 
  out_bio_air = readRDS(paste(path_to_multi_Results_report, "out_bio_NOx.rds",sep=""))
  out_clus_air = readRDS(paste(path_to_multi_Results_report, "out_metab_clus_NOx.rds",sep=""))
  out_combine_air = readRDS(paste(path_to_multi_Results_report, "out_combine_NOx.rds",sep=""))
  ## betas ## 
  bio_betas_air  = readRDS(paste(path_to_multi_Results_report, "betas_bio_NOx.rds",sep=""))
  clus_betas_air  = readRDS(paste(path_to_multi_Results_report, "betas_stability_clus_NOx.rds",sep=""))
  combine_betas_air  = readRDS(paste(path_to_multi_Results_report, "betas_combine_NOx.rds",sep=""))
}
if(PM2.5_10){
  path_to_multi_Results_report = "/rds/general/project/hda_students_data/live/Group2/Alicia/Summer_project/Results_report/Multivariate_obj1/Air_clus_bio/lasso/pfer/"
  ## sel prop ##
  bio_sp_air = readRDS(paste(path_to_multi_Results_report, "selprop_bio_PM2.5_10.rds",sep=""))
  clus_sp_air = readRDS(paste(path_to_multi_Results_report, "selprop_metab_clus_PM2.5_10.rds",sep=""))
  combine_sp_air = readRDS(paste(path_to_multi_Results_report, "selprop_combine_PM2.5_10.rds",sep=""))
  ## out ## 
  out_bio_air = readRDS(paste(path_to_multi_Results_report, "out_bio_PM2.5_10.rds",sep=""))
  out_clus_air = readRDS(paste(path_to_multi_Results_report, "out_metab_clus_PM2.5_10.rds",sep=""))
  out_combine_air = readRDS(paste(path_to_multi_Results_report, "out_combine_PM2.5_10.rds",sep=""))
  ## betas ## 
  bio_betas_air  = readRDS(paste(path_to_multi_Results_report, "betas_bio_PM2.5_10.rds",sep=""))
  clus_betas_air  = readRDS(paste(path_to_multi_Results_report, "betas_stability_clus_PM2.5_10.rds",sep=""))
  combine_betas_air  = readRDS(paste(path_to_multi_Results_report, "betas_combine_PM2.5_10.rds",sep=""))
}
if(PM2.5_abs){
  path_to_multi_Results_report = "/rds/general/project/hda_students_data/live/Group2/Alicia/Summer_project/Results_report/Multivariate_obj1/Air_clus_bio/lasso/pfer/"
  ## sel prop ##
  bio_sp_air = readRDS(paste(path_to_multi_Results_report, "selprop_bio_PM_abs.rds",sep=""))
  clus_sp_air = readRDS(paste(path_to_multi_Results_report, "selprop_metab_clus_PM_abs.rds",sep=""))
  combine_sp_air = readRDS(paste(path_to_multi_Results_report, "selprop_combine_PM_abs.rds",sep=""))
  ## out ## 
  out_bio_air = readRDS(paste(path_to_multi_Results_report, "out_bio_PM_abs.rds",sep=""))
  out_clus_air = readRDS(paste(path_to_multi_Results_report, "out_metab_clus_PM_abs.rds",sep=""))
  out_combine_air = readRDS(paste(path_to_multi_Results_report, "out_combine_PM_abs.rds",sep=""))
  ## betas ## 
  bio_betas_air  = readRDS(paste(path_to_multi_Results_report, "betas_bio_PM_abs.rds",sep=""))
  clus_betas_air  = readRDS(paste(path_to_multi_Results_report, "betas_stability_clus_PM_abs.rds",sep=""))
  combine_betas_air  = readRDS(paste(path_to_multi_Results_report, "betas_combine_PM_abs.rds",sep=""))
}
if(Major_road){
  path_to_multi_Results_report = "/rds/general/project/hda_students_data/live/Group2/Alicia/Summer_project/Results_report/Multivariate_obj1/Air_clus_bio/lasso/pfer/"
  ## sel prop ##
  bio_sp_air = readRDS(paste(path_to_multi_Results_report, "selprop_bio_road.rds",sep=""))
  clus_sp_air = readRDS(paste(path_to_multi_Results_report, "selprop_metab_clus_road.rds",sep=""))
  combine_sp_air = readRDS(paste(path_to_multi_Results_report, "selprop_combine_road.rds",sep=""))
  ## out ## 
  out_bio_air = readRDS(paste(path_to_multi_Results_report, "out_bio_road.rds",sep=""))
  out_clus_air = readRDS(paste(path_to_multi_Results_report, "out_metab_clus_road.rds",sep=""))
  out_combine_air = readRDS(paste(path_to_multi_Results_report, "out_combine_road.rds",sep=""))
  ## betas ## 
  bio_betas_air  = readRDS(paste(path_to_multi_Results_report, "betas_bio_road.rds",sep=""))
  clus_betas_air  = readRDS(paste(path_to_multi_Results_report, "betas_stability_clus_road.rds",sep=""))
  combine_betas_air  = readRDS(paste(path_to_multi_Results_report, "betas_combine_road.rds",sep=""))
}
...
# ------------lasso cvd v.s. air pollutants-------------------------------------------------------------

combine_sp = as.data.frame(combine_sp)
colnames(combine_sp)[1] = "sp"
combine_sp$encoding<-rownames(combine_sp)
combine_sp$type<-rep("cvd",times=nrow(combine_sp))

combine_sp_air = as.data.frame(combine_sp_air)
colnames(combine_sp_air)[1] = "sp"
combine_sp_air$encoding<-rownames(combine_sp_air)
combine_sp_air$type<-rep("air",times=nrow(combine_sp_air))

selection = cbind(combine_sp,combine_sp_air)
colnames(selection)[1] = "sp_cvd"
colnames(selection)[4] = "sp_air"
...
combine_op_sp<-Argmax(out_combine)[2]
combine_air_op_sp<-Argmax(out_combine_air)[2]

selection = selection %>% mutate(selection$newcolour,ifelse(sp_cvd<combine_op_sp & sp_air<combine_air_op_sp, "grey",mycolour_point))
colnames(selection)[6] = "newcolour"
...
p1=ggplot(selection,
          aes(sp_cvd, sp_air, label=ifelse(sp_cvd<combine_op_sp & sp_air<combine_air_op_sp,"",selection$features))) +
  geom_abline(slope = 1,linetype = "dotted",colour = "grey") +
  geom_vline(aes(xintercept = combine_op_sp),linetype = "dashed",colour = "coral") +
  geom_hline(aes(yintercept = combine_air_op_sp),linetype = "dashed",colour = "coral") +
  geom_point(colour=selection$newcolour) +
  geom_label_repel(color=selection$newcolour,
                   ...
                   nudge_y = 0.001, nudge_x = 0.001, box.padding = 0.3,
                   label.size = NA, label.padding=.01, na.rm=TRUE, fill = alpha(c("white"),0.99)) +
  xlab("Selection Proportion (CVD outcome)")+
...
pdf(paste(path_to_figure, "report_lasso_cvdabs_sp.pdf",sep =""), width = 5.5, height = 5.5)
p1
dev.off()
