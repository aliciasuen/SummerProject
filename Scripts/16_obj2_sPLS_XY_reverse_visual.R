...
if(met_no_bio){
  metab_clus = readRDS(paste(path, "Results/denoised_clus_no_bio.rds", sep =""))
  metab_clus = metab_clus[order(as.numeric(row.names(metab_clus))), ] 
  path_to_figure = "/rds/general/project/hda_students_data/live/Group2/Alicia/Summer_project/Figures/Multivariate_obj2/Air_clus_bio/sensitivity_XY_reverse/"
  path_to_multi_results = "/rds/general/project/hda_students_data/live/Group2/Alicia/Summer_project/Results/Multivariate_obj2/Air_clus_bio/sensitivity_XY_reverse/"
  ## sel prop X ##
  bio_sp = readRDS(paste(path_to_multi_results, "sparsityX/selprop_spls_bio.rds",sep=""))
  clus_sp = readRDS(paste(path_to_multi_results, "sparsityX/selprop_spls_metab_clus_base.rds",sep=""))
  combine_sp = readRDS(paste(path_to_multi_results, "sparsityX/selprop_spls_combine.rds",sep=""))
  ...
  clus_sp_X = readRDS(paste(path_to_multi_results, "sparsityXY/selpropX_spls_metab_clus_base.rds",sep=""))
  combine_sp_X = readRDS(paste(path_to_multi_results, "sparsityXY/selpropX_spls_combine.rds",sep=""))
  bio_sp_Y1 = readRDS(paste(path_to_multi_results, "sparsityXY/selpropY_spls_bio.rds",sep=""))
  clus_sp_Y1 = readRDS(paste(path_to_multi_results, "sparsityXY/selpropY_spls_metab_clus_base.rds",sep=""))
  combine_sp_Y1 = readRDS(paste(path_to_multi_results, "sparsityXY/selpropY_spls_combine.rds",sep=""))
  ## out XY ## 
  bio_out_XY = readRDS(paste(path_to_multi_results, "sparsityXY/out_spls_bio.rds",sep=""))
  clus_out_XY = readRDS(paste(path_to_multi_results, "sparsityXY/out_spls_metab_clus_base.rds",sep=""))
  combine_out_XY = readRDS(paste(path_to_multi_results, "sparsityXY/out_spls_combine.rds",sep=""))
...
if(ncomp3){
  ...
  path_to_multi_results = "/rds/general/project/hda_students_data/live/Group2/Alicia/Summer_project/Results/Multivariate_obj2/Air_clus_bio/sensitivity_XY_reverse/"
  ## sel prop X_1 ##
  bio_sp_X1 = readRDS(paste(path_to_multi_results, "sparsityXY_ncomp3/selpropX_1_spls_bio_base.rds",sep=""))
  clus_sp_X1 = readRDS(paste(path_to_multi_results, "sparsityXY_ncomp3/selpropX_1_spls_metab_clus_base.rds",sep=""))
  combine_sp_X1 = readRDS(paste(path_to_multi_results, "sparsityXY_ncomp3/selpropX_1_spls_combine_base.rds",sep=""))
  ## sel prop X_2 ##
  bio_sp_X2 = readRDS(paste(path_to_multi_results, "sparsityXY_ncomp3/selpropX_2_spls_bio_base.rds",sep=""))
  clus_sp_X2 = readRDS(paste(path_to_multi_results, "sparsityXY_ncomp3/selpropX_2_spls_metab_clus_base.rds",sep=""))
  combine_sp_X2 = readRDS(paste(path_to_multi_results, "sparsityXY_ncomp3/selpropX_2_spls_combine_base.rds",sep=""))
  ## sel prop X_3 ##
  bio_sp_X3 = readRDS(paste(path_to_multi_results, "sparsityXY_ncomp3/selpropX_3_spls_bio_base.rds",sep=""))
  clus_sp_X3 = readRDS(paste(path_to_multi_results, "sparsityXY_ncomp3/selpropX_3_spls_metab_clus_base.rds",sep=""))
  combine_sp_X3 = readRDS(paste(path_to_multi_results, "sparsityXY_ncomp3/selpropX_3_spls_combine_base.rds",sep=""))
  
  ## sel prop Y_1 ##
  bio_sp_Y1 = readRDS(paste(path_to_multi_results, "sparsityXY_ncomp3/selpropY_1_spls_bio_base.rds",sep=""))
  clus_sp_Y1 = readRDS(paste(path_to_multi_results, "sparsityXY_ncomp3/selpropY_1_spls_metab_clus_base.rds",sep=""))
  combine_sp_Y1 = readRDS(paste(path_to_multi_results, "sparsityXY_ncomp3/selpropY_1_spls_combine_base.rds",sep=""))
  ## sel prop Y_2 ##
  bio_sp_Y2 = readRDS(paste(path_to_multi_results, "sparsityXY_ncomp3/selpropY_2_spls_bio_base.rds",sep=""))
  clus_sp_Y2 = readRDS(paste(path_to_multi_results, "sparsityXY_ncomp3/selpropY_2_spls_metab_clus_base.rds",sep=""))
  combine_sp_Y2 = readRDS(paste(path_to_multi_results, "sparsityXY_ncomp3/selpropY_2_spls_combine_base.rds",sep=""))
  ## sel prop Y_3 ##
  bio_sp_Y3 = readRDS(paste(path_to_multi_results, "sparsityXY_ncomp3/selpropY_3_spls_bio_base.rds",sep=""))
  clus_sp_Y3 = readRDS(paste(path_to_multi_results, "sparsityXY_ncomp3/selpropY_3_spls_metab_clus_base.rds",sep=""))
  combine_sp_Y3 = readRDS(paste(path_to_multi_results, "sparsityXY_ncomp3/selpropY_3_spls_combine_base.rds",sep=""))
  ## OUT  ##
  bio_out = readRDS(paste(path_to_multi_results, "sparsityXY_ncomp3/out_spls_bio_base.rds",sep=""))
  clus_out = readRDS(paste(path_to_multi_results, "sparsityXY_ncomp3/out_spls_metab_clus_base.rds",sep=""))
  combine_out = readRDS(paste(path_to_multi_results, "sparsityXY_ncomp3/out_spls_combine_base.rds",sep=""))
...
# ---------------ggplot combining all sparsity on X  ----------------------------------------------------------
## ncomp = 1 ##
clus_sp_X1 = as.data.frame(clus_sp_X1)
bio_sp_X1 = as.data.frame(bio_sp_X1)
combine_sp_X1 = as.data.frame(combine_sp_X1)


colnames(clus_sp_X1)[1] = "sp"
colnames(bio_sp_X1)[1] = "sp"
colnames(combine_sp_X1)[1] = "sp"

clus_sp_X1$type<-rep("Metabolites",times=nrow(clus_sp_X1))
bio_sp_X1$type<-rep("Biomarkers",times=nrow(bio_sp_X1))
combine_sp_X1$type<-rep("Combined",times=nrow(combine_sp_X1))

clus_sp_X1$encoding<-rownames(clus_sp_X1)
bio_sp_X1$encoding<-rownames(bio_sp_X1)
combine_sp_X1$encoding<-rownames(combine_sp_X1)

selection<- rbind(clus_sp_X1,bio_sp_X1,combine_sp_X1)
...
ggplot(data=selection,aes(x=reorder(encoding,sp),
  ...
  geom_hline(yintercept = c(bio_op_sp[1],combine_op_sp[1],clus_op_sp[1]), linetype="dashed", color = c("red","green","skyblue"))+ 
  # geom_hline(yintercept = clus_NO2_op_sp, ) + geom_hline(yintercept =bio_NO2_op_sp )+ geom_hline(yintercept =combine_NO2_op_sp)+
   ggsave(height=18, width=15,path = path_to_figure, filename="all_sp_X1.pdf")

## ncomp =2 ##
clus_sp_X2 = as.data.frame(clus_sp_X2)
bio_sp_X2 = as.data.frame(bio_sp_X2)
combine_sp_X2 = as.data.frame(combine_sp_X2)

colnames(clus_sp_X2)[1] = "sp"
colnames(bio_sp_X2)[1] = "sp"
colnames(combine_sp_X2)[1] = "sp"

clus_sp_X2$type<-rep("Metabolites",times=nrow(clus_sp_X2))
bio_sp_X2$type<-rep("Biomarkers",times=nrow(bio_sp_X2))
combine_sp_X2$type<-rep("Combined",times=nrow(combine_sp_X2))

clus_sp_X2$encoding<-rownames(clus_sp_X2)
bio_sp_X2$encoding<-rownames(bio_sp_X2)
combine_sp_X2$encoding<-rownames(combine_sp_X2)

selection<- rbind(clus_sp_X2,bio_sp_X2,combine_sp_X2)
...
ggplot(data=selection,aes(x=reorder(encoding,sp),
  ...
  geom_tile(aes(x = factor(encoding), y = 0, height = Inf, width = 0.75), data = selection, alpha = 0.05) + 
  coord_flip(ylim=c(0,1))+ 
  geom_hline(yintercept = c(bio_op_sp[2],combine_op_sp[2],clus_op_sp[2]), linetype="dashed", color = c("red","green","skyblue"))+ 
  # geom_hline(yintercept = clus_NO2_op_sp, ) + geom_hline(yintercept =bio_NO2_op_sp )+ geom_hline(yintercept =combine_NO2_op_sp)+
  ggsave(height=18, width=15,path = path_to_figure, filename="all_sp_X2.pdf")

## ncomp =3 ##
clus_sp_X3 = as.data.frame(clus_sp_X3)
bio_sp_X3 = as.data.frame(bio_sp_X3)
combine_sp_X3 = as.data.frame(combine_sp_X3)

colnames(clus_sp_X3)[1] = "sp"
colnames(bio_sp_X3)[1] = "sp"
colnames(combine_sp_X3)[1] = "sp"

clus_sp_X3$type<-rep("Metabolites",times=nrow(clus_sp_X3))
bio_sp_X3$type<-rep("Biomarkers",times=nrow(bio_sp_X3))
combine_sp_X3$type<-rep("Combined",times=nrow(combine_sp_X3))

clus_sp_X3$encoding<-rownames(clus_sp_X3)
bio_sp_X3$encoding<-rownames(bio_sp_X3)
combine_sp_X3$encoding<-rownames(combine_sp_X3)

selection<- rbind(clus_sp_X3,bio_sp_X3,combine_sp_X3)
...
ggplot(data=selection,aes(x=reorder(encoding,sp),
  ...
  geom_tile(aes(x = factor(encoding), y = 0, height = Inf, width = 0.75), data = selection, alpha = 0.05) + 
  coord_flip(ylim=c(0,1))+ 
  geom_hline(yintercept = c(bio_op_sp[3],combine_op_sp[3],clus_op_sp[3]), linetype="dashed", color = c("red","green","skyblue"))+ 
  # geom_hline(yintercept = clus_NO2_op_sp, ) + geom_hline(yintercept =bio_NO2_op_sp )+ geom_hline(yintercept =combine_NO2_op_sp)+
  ggsave(height=18, width=15,path = path_to_figure, filename="all_sp_X3.pdf")
...
clus_op_sp<-clus_out_XY$summary$pix
bio_op_sp<-bio_out_XY$summary$pix
combine_op_sp<-combine_out_XY$summary$pix
...
# ----------ggplots on all sparsity on Y ---------------------------------------------------------------
## ncomp =1 ##
clus_sp_Y1 = t(clus_sp_Y1)
clus_sp_Y1 = as.data.frame(clus_sp_Y1)
bio_sp_Y1 = t(bio_sp_Y1)
bio_sp_Y1 = as.data.frame(bio_sp_Y1)
combine_sp_Y1=t(combine_sp_Y1)
...
clus_op_sp<-clus_out_XY$summary$piy
bio_op_sp<-bio_out_XY$summary$piy
combine_op_sp<-combine_out_XY$summary$piy
...
ggplot(data=selection,aes(x=reorder(encoding,sp),
  ...
  geom_tile(aes(x = factor(encoding), y = 0, height = Inf, width = 0.75), data = selection, alpha = 0.05) + 
  coord_flip(ylim=c(0,1))+ 
  geom_hline(yintercept = c(clus_op_sp[2],bio_op_sp[2],combine_op_sp[2]), linetype="dashed", color = c("skyblue","green","red")) +
  # geom_hline(yintercept = clus_NO2_op_sp, ) + geom_hline(yintercept =bio_NO2_op_sp )+ geom_hline(yintercept =combine_NO2_op_sp)+
  ggsave(height=18, width=15,path = path_to_figure, filename="all_sp_Y2.pdf")
